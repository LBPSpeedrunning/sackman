...
startup
{
	...
	settings.SetToolTip("autostartintro", "Used for Individual Level speedruns. If doing Introduction, the regular autosplitting is required for the autoend.");
...
split
{
	...
	{
		if (old.slotnumber != 0 && old.idoflevelswitch == 0 && current.idoflevelswitch == 10169)
		{
			return true;
		}
	}
